...
export const metadata: Metadata = generatePageMetadata({
  title: "Cassette AC Services in Hyderabad — Repair, Installation, Gas Charging",
  description:
    "Premium ceiling-mounted cassette AC services in Hyderabad — installation, repair, servicing, and AMC for offices, hotels, and residences. Same-day service by RSG Refrigeration.",
  path: "/services/cassette-ac",
  keywords: [
    "cassette ac services hyderabad",
    "cassette ac repair hyderabad",
    "cassette ac installation hyderabad",
    "cassette ac service hyderabad",
  ],
});
...
export default function CassetteACPage() {
  const breadcrumbData = breadcrumbSchema([
    ...
    { name: "Cassette AC Services", url: "/services/cassette-ac" },
  ]);
      ...
      <section className="bg-hero py-16 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <nav className="flex items-center gap-2 text-sm text-white/50 mb-6">
            ...
            <span>/</span>
            <span className="text-white">Cassette AC</span>
          </nav>
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-5 leading-tight">
              Cassette AC Services in Hyderabad
              <br />
              <span className="text-[#F5A623]">Ceiling-Mounted Specialists</span>
            </h1>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#111827] mb-3">
              All <span className="gradient-text">Cassette AC Services</span>
            </h2>
            <p className="text-gray-500">Select any service for detailed information, pricing, and booking</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {CASSETTE_AC_SERVICES.map((svc) => (
              <Link
                key={svc.slug}
                href={`/services/cassette-ac/${svc.slug}`}

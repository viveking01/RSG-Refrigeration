...
export const metadata: Metadata = generatePageMetadata({
  ...
  description:
    "Expert VRF/VRV system installation, commissioning, maintenance, and repair services in Hyderabad. Multi-zone climate control solutions by RSG Refrigeration.",
  path: "/services/vrf-vrv-ac",
  keywords: [
    "vrf system services hyderabad",
    "vrv system repair hyderabad",
    "vrf ac installation hyderabad",
    "vrv multi-zone ac service",
  ],
});

export default function VRFACPage() {
  const breadcrumbData = breadcrumbSchema([
    { name: "Services", url: "/services" },
    { name: "VRF / VRV AC Services", url: "/services/vrf-vrv-ac" },
  ]);
      ...
      <section className="bg-hero py-16 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <nav className="flex items-center gap-2 text-sm text-white/50 mb-6">
            ...
            <span>/</span>
            <span className="text-white">VRF / VRV AC</span>
          </nav>
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-5 leading-tight">
              VRF / VRV System Services in Hyderabad
              <br />
              <span className="text-[#F5A623]">Multi-Zone Climates</span>
            </h1>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#111827] mb-3">
              All <span className="gradient-text">VRF / VRV AC Services</span>
            </h2>
            <p className="text-gray-500">Select any service for detailed information, pricing, and booking</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {VRF_AC_SERVICES.map((svc) => (
              <Link
                key={svc.slug}
                href={`/services/vrf-vrv-ac/${svc.slug}`}

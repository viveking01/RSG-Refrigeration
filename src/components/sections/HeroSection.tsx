    ...
    <section className="relative min-h-[85vh] flex items-center bg-hero overflow-hidden">
      ...
      <div className="container-custom relative z-10 py-20 md:py-28">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/8 border border-white/15 text-white/80 text-sm font-medium mb-6">
          ...
          <div className="hidden lg:block">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl mb-5 h-[340px]">
              <Image
        ...
        <div className="lg:hidden mt-10 grid grid-cols-2 sm:grid-cols-3 gap-3">
